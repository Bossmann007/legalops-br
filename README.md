...
- See [CHANGELOG.md](.claude/docs/CHANGELOG.md) · [ARCHITECTURE.md](.claude/docs/ARCHITECTURE.md) · [RUNBOOK.md](.claude/docs/RUNBOOK.md) · [SECURITY.md](.claude/docs/SECURITY.md)
...
### Chaves opcionais (defesa em profundidade)
